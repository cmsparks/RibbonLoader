...
'Get content for dynamic VTub menu
    ...
    If VTubRootNode.Controls.Count > 1 Then Exit Sub

    'Delete the preexisting Create VTub button if recreating
    If VTubRootNode.Controls.Count = 1 Then VTubRootNode.Controls(1).Delete
    ...
    VTubPOSIX = MacScript("get quoted form of POSIX path of """ & VTubPath & """")
